                ...
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    <div class="form-top" style="width: 450px">
                        <div class="form-top-left">
                            ...
                            <p><c:if test="${adminLoginMess!=null}">登陆失败，失败原因：${adminLoginMess}</c:if>
                             <c:remove var="adminLoginMess"/>
                            </p>
                        </div>
                    ...
                    <div class="form-bottom" style="width: 450px">
                        ...
                        <form role="form" action="${path}/admin/login" method="post" class="login-form" id="loginForm">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="username" minlength="2" placeholder="请输入用户名..." class="form-username form-control" required id="form-username">
                            </div>
                            <div class="form-group">
                                <label class="sr-only" for="form-password">Password</label>
                                <input type="password" name="password" minlength="2" placeholder="请输入密码..." class="form-password form-control" required id="form-password">
                            </div>
                            <div class="form-group">
                                <%--<label class="sr-only" for="form-code">Code</label>--%>
                                <input placeholder="请输入验证码..." minlength="2" style="width: 289px;height: 50px;border:3px solid #ddd;border-radius: 4px;" required type="text" name="enCode" id="form-code">
