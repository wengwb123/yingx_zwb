    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#loginButtonId").click(function () {
                var valid = $("#loginForm").valid();//判断表单验证是否通过
                if(valid){
                    ...
                    <div class="form-bottom" style="width: 450px">
                        ...
                        <form role="form" action="" method="post" class="login-form" id="loginForm">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="username" minlength="3" placeholder="请输入用户名..." class="form-username form-control" required id="form-username">
                            </div>
                            <div class="form-group">
                                <label class="sr-only" for="form-password">Password</label>
                                <input type="password" name="password" minlength="6" placeholder="请输入密码..." class="form-password form-control" required id="form-password">
                            </div>
                            <div class="form-group">
                                <%--<label class="sr-only" for="form-code">Code</label>--%>
                                <input placeholder="请输入验证码..." minlength="4" maxlength="4" style="width: 289px;height: 50px;border:3px solid #ddd;border-radius: 4px;" required type="text" name="enCode" id="form-code">
